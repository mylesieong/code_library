      ...
      * DESCRPITION   : Build master file LNSTPF                             *
      *                                                                      *
      ************************************************************************
      ...
      *Fetch loan records that should review for the first time*
      ...
      *Fetch loan records that should review but not their first review*
     ...
     C                   RETURN
      *******************sub: chk_typ*******************************************
      *check if loan record meets review types*
     C     CHK_TYP       BEGSR
     C                   EVAL      CHK_TYP_I=0
