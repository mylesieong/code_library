...
public class PayrollScreen_1 extends MainScreen implements ActionListener, FocusListener, CellEditorListener, KeyListener, WindowListener, DocumentListener {
	...
	public PayrollScreen_1() throws NumberFormatException, ClassNotFoundException, SQLException {
		this(null);
	}
	
	public PayrollScreen_1(Properties config) throws NumberFormatException, ClassNotFoundException, SQLException {
		super(config);
		try {
