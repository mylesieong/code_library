...
public class BakPayrollScreen extends MainScreen implements ActionListener, FocusListener, CellEditorListener, KeyListener, WindowListener, DocumentListener {
	...
	public BakPayrollScreen() throws NumberFormatException, ClassNotFoundException, SQLException {
		this(null);
	}
	
	public BakPayrollScreen(Properties config) throws NumberFormatException, ClassNotFoundException, SQLException {
		super(config);
		try {
	...
	private void init() throws SQLException, ClassNotFoundException {
		...
		if(ln.getLanguage() == Language.CN) {
			...
			fntSearch = new Font("Tahoma", Font.ITALIC, 20); //11
			fnt14 = new Font("Tahoma", Font.BOLD, 20); //14
		}
