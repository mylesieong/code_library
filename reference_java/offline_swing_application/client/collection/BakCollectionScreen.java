...
public class BakCollectionScreen extends MainScreen implements ActionListener, FocusListener, CellEditorListener, KeyListener, WindowListener, DocumentListener {
	...
	public BakCollectionScreen() throws NumberFormatException, ClassNotFoundException, SQLException {
		this(null);
	}
	
	public BakCollectionScreen(Properties config) throws NumberFormatException, ClassNotFoundException, SQLException {
		super(config);
		try {
	...
	public void init() throws SQLException, ClassNotFoundException {
		...
		txtPaymentDate.setBounds(62, 49, 96, 18);
		...
		txtPaymentID.setBounds(62, 23, 128, 18);
		...
		txtTotalTxn.setBounds(62, 40, 128, 18);
		...
		lblInputtedAmount.setBounds(12, 138, 117, 14);
		...
		txtInputtedAmount.setBounds(62, 153, 128, 18);
		...
		txtInputtedRecord.setBounds(62, 119, 128, 18);
		panel.add(txtInputtedRecord);
		
		lblInputtedRecord = new JLabel(ln._InputtedRecord());
		lblInputtedRecord.setBounds(12, 104, 117, 14);
		...
		txtPartyName.setBounds(62, 49, 128, 18);
		...
		txtPartyCode.setBounds(62, 23, 128, 18);
					...
					.addGroup(gl_panMain.createParallelGroup(Alignment.LEADING, false)
						.addGroup(gl_panMain.createSequentialGroup()
							.addGroup(gl_panMain.createParallelGroup(Alignment.LEADING)
								.addComponent(panParty, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
								.addComponent(panPayment, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(Alignment.TRAILING, gl_panMain.createSequentialGroup()
							...
							.addGap(17)))
					.addComponent(scp, GroupLayout.DEFAULT_SIZE, 537, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_panMain.setVerticalGroup(
			gl_panMain.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panMain.createSequentialGroup()
					.addGroup(gl_panMain.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panMain.createSequentialGroup()
							.addComponent(panParty, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(panPayment, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							...
							.addGroup(gl_panMain.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(lblSeq)))
						.addComponent(scp, GroupLayout.DEFAULT_SIZE, 464, Short.MAX_VALUE))
					.addContainerGap())
		);
		
		btnDatePicker = new JButton("...");
		btnDatePicker.addActionListener(this);
		btnDatePicker.setBounds(168, 49, 22, 18);
